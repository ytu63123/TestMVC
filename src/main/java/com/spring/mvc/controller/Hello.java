...
public class Hello {
    ...
    public String login(@RequestParam String username, @RequestParam(required = false) String password) {
        return "username: " + username + ", password: " + password + ", Login OK";
    }

    // login2?usr=admin&pwd=1234
    @RequestMapping(value = {"/login2"})
    @ResponseBody
    public String login2(@RequestParam(name = "usr") String username, @RequestParam(name = "pwd") String password) {
        return "username: " + username + ", password: " + password + ", Login2 OK";
    }
